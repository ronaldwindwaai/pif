                    ...
                    <div class="card-body">
                        <div class="bt-wizard" id="progresswizard">
                            <ul class="nav nav-pills nav-fill mb-3">
                                <li class="nav-item"><a href="#progress-t-tab1" class="nav-link" data-toggle="tab">Programme/Activity General Information</a></li>
                                <li class="nav-item"><a href="#progress-t-tab2" class="nav-link" data-toggle="tab">Budget & Actual Provisions for Participants</a></li>
                                <li class="nav-item"><a href="#progress-t-tab3" class="nav-link" data-toggle="tab">Consultants & Support Personnel</a></li>
                            </ul>
                                ...
                                <div class="tab-pane active show" id="progress-t-tab1">
                                    <form>
                                        <div class="form-group">
                                            <label class="form-label" for="name_of_the_meeting">Name of the Meeting</label>
                                            <input id="name_of_the_meeting" type="text" class="form-control @error('name_of_the_meeting') is-invalid @enderror"  @error('name_of_the_meeting') aria-invalid="true" @enderror name="name_of_the_meeting" required placeholder="Name of the Meeting" value="{{ old('name_of_the_meeting') }}">
                                         </div>
