...
@section('content')
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <input id="title" type="text" class="form-control @error('title') is-invalid @enderror"
                                        ...
                                        placeholder="Name of the Resources" value="{{ $data->title }}">
                                </div>
                            </div>
                            @if (!empty($officers))
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-basic-multiple col-md-6" name="programme_id">
                                            @foreach ($programmes as $programme)
                                                <option {{ $data->programme_id == $programme->id ? 'selected' : '' }}
                                                    value="{{ $programme->id }}">{{ $programme->title }}</option>
                                            @endforeach
                                        </select>
                                        @role('super-admin')
                                            <button type="button" class="btn btn-sm  btn-outline-primary has-ripple"
                                            data-toggle="modal" data-target="#modal-new-programme">New</button>
                                        @endrole
                                    </div>
                                </div>
                            @endif
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('objective') is-invalid @enderror"
                                        @error('objective') required aria-invalid="true" @enderror name="objective"
                                        id="objective" placeholder="Project objective">{{ $data->objective }}</textarea>
                                </div>
                            </div>
                        </div>
    ...
    <!-- [ Main Content ] end -->
    @role('super-admin')
    <div class="modal fade" id="modal-new-officer" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
        aria-hidden="true">
...
<div class="modal fade" id="modal-new-programme" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="form" action="{{ route('programmes.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                        ...
                        @if (!empty($managers))
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <select class="col-md-6" name="manager_id">
