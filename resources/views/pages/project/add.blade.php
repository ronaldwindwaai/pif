                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <p>Kindly assign the Officer responsible for this Project.</p>
                                ...
                                @role('super-admin')
                                    <button type="button" class="btn btn-sm  btn-outline-primary has-ripple" data-toggle="modal" data-target="#modal-new-officer">New</button>
                                @endrole
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="col-md-10">
                            ...
                            <p>Kindly select the programme this project belongs too.</p>
                                ...
                                @role('super-admin')
                                    <button type="button" class="btn btn-sm  btn-outline-primary has-ripple" data-toggle="modal" data-target="#modal-new-programme">New</button>
                                @endrole
                            </div>
                        </div>
                        @endif
...
<!-- [ Main Content ] end -->
@role('super-admin')
<div class="modal fade" id="modal-new-officer" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
...
<div class="modal fade" id="modal-new-programme" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="form" action="{{ route('programmes.store') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-10">
